...
import { usePrefsStore, applyTheme } from './store/prefs.store.js'
import './index.css'

// Применяем сохранённую тему ДО первого рендера, чтобы не было
// мигания светлым→тёмным при загрузке.
